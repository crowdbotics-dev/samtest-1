"""
Django settings for samtest_1 project.
...
WSGI_APPLICATION = 'samtest_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "samtest_1 API",
    "DESCRIPTION": "API documentation for samtest_1 App",
    "VERSION": "v1",
}
